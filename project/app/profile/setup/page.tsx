        ...
        <div className="mb-8 flex items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Name & category</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Rate, skills & bio</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-border/60 bg-card p-8 shadow-xl">
          <div className="mb-6">
            ...
            <p className="mt-1 text-center text-sm text-muted-foreground">
              This is how clients will find and hire you on TrustGig
            </p>
          </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="title"
                    type="text"
                    placeholder="e.g. Graphic Designer, Home Repair Specialist"
                    value={title}
          ...
          {step === 2 && (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between rounded-xl border border-border/60 p-4">
                <div>
                  <p className="text-sm font-medium text-foreground">Offer local services</p>
                  <p className="text-xs text-muted-foreground">Enable if you serve clients in person</p>
                </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={responseTime} onValueChange={setResponseTime}>
                  <SelectTrigger id="responseTime" className="h-12">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button type="button" variant="outline" className="h-12" onClick={addSkill}>
                    Add
                  </Button>
                </div>
                {skills.length > 0 && (
